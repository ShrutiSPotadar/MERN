...
//  It is a programming interface and representation of structured documents.
// The DOM represents the structure of a document as a tree of objects,
// where each object corresponds to a part of the document, such as elements, attributes, text, etc.
// This model allows programs and scripts to dynamically access and manipulate the content, structure, and style of documents.
...
const firstPara = documet.querySelector("p");
const item = document.querySelector("li");
const divs = document.getElementsByTagName("div");
const classElement = document.getElementsByClassName("red");

// Here is a list of some common DOM (Document Object Model)
// properties and methods that you can use to manipulate HTML elements:
